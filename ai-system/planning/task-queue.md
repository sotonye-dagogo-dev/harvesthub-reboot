...
- [x] Validation and documentation sync.
  ...
  - [x] Update `ai-system/system-architecture.md` with the canonical email delivery/template flow if the audit changes the contract.
...
- [x] Expose runtime-safe Paystack public key in payment config contracts while honoring existing env naming/fallbacks.
- [x] Add reusable client-side Paystack inline launcher utility and deterministic payment-reference helper.
- [x] Migrate checkout card payment flow from server initialize endpoint to inline popup initialization.
- [x] Migrate wallet deposit and ad-payment entry points to inline popup initialization.
- [x] Add `/api/paystack-webhook` POST route alias to current webhook reconciliation handler.
- [x] Update focused tests affected by the inline initialization flow and verify webhook compatibility path.
...
- [x] Finalize validation and documentation closure for this reliability slice.
  ...
  - [x] Update `ai-system/system-architecture.md` with corrected payment verification flow and notification/email delivery contracts.
...
- [ ] Validation and docs synchronization.
  ...
  - [ ] Update `ai-system/system-architecture.md` with payment fallback flow and reconciliation responsibilities.
...
- [ ] Validation and documentation sync.
  - [ ] Run focused validation: touched `vitest`, touched lint, and `tsc --noEmit`.
  - [ ] Update `ai-system/system-architecture.md` with unified banner CTA resolver flow, profile mutation boundary, and signup phone->WhatsApp fallback contract.
...
- [ ] Update `ai-system/design-system.md` and `ai-system/system-architecture.md` to reflect new components and data flow
...
- [x] Update `ai-system/system-architecture.md` with new account-conversion flow and profile/store persistence data paths once implementation lands.
...
- [x] Finalize documentation and architecture notes.
  - [x] Update `ai-system/system-architecture.md` with product discovery query flow and config module reference.
...
- [x] Finalize architecture/docs synchronization.
  - [x] Update `ai-system/system-architecture.md` with unified runtime data flow.
...
- [x] Finalize validation and documentation sync.
  ...
  - [x] Update `ai-system/system-architecture.md`, `ai-system/repair-system.md`, `ai-system/memory/project-decisions.md`, `ai-system/checkpoints/session-log.md`, and `ai-system/summaries/dev-history.md`.
...
- [x] Documentation synchronization.
  - [x] Update `ai-system/system-architecture.md` banner composition flow with new sizing contract language.
...
- [x] Documentation synchronization.
  - [x] Update `ai-system/system-architecture.md` for:
...
- [x] Track F - Validation, regression tests, and docs sync.
  ...
  - [x] Update `ai-system/system-architecture.md`, `ai-system/checkpoints/session-log.md`, `ai-system/summaries/dev-history.md`, and `ai-system/memory/project-decisions.md` after implementation.
...
- [x] Slice 7 — Final quality gate + documentation closure.
  ...
  - [x] Update `ai-system/system-architecture.md`, `ai-system/memory/project-decisions.md`, and `ai-system/repair-system.md` where contracts/patterns changed.
