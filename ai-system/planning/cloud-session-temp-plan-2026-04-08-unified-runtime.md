...
- `ai-system/system-architecture.md` (runtime flow updates)
...
- Update ai-system/system-architecture.md when runtime flow/structure changes
- Log new reliability patterns in ai-system/repair-system.md
