...
import { Button, Card, PageLoader, booleanColor } from "@/components/ui";
import { ArrowLeft, Package, Eye, EyeOff, Star, Trash2, ExternalLink } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:col-span-2">
            ...
            <Card>
              <div className="flex flex-wrap gap-3">
                {product.images.map((img, i) => (
                  <div
                    key={i}
                    className="relative h-32 w-32 rounded-ds-md overflow-hidden border border-ds-border-base"
                  >
                    <Image
                      src={img}
          ...
          {/* Details */}
          <Card>
            <h2 className="mb-4 text-base font-semibold text-ds-text-primary">Product Details</h2>
        ...
        <div className="space-y-4">
          <Card>
            <h2 className="mb-4 text-base font-semibold text-ds-text-primary">Moderation</h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between rounded-ds-md border border-ds-border-base p-3">
                <div className="flex items-center gap-2">
                  {product.isActive ? (
              ...
              <div className="flex items-center justify-between rounded-ds-md border border-ds-border-base p-3">
                <div className="flex items-center gap-2">
                  <Star className="h-4 w-4 text-ds-status-warning-text" />
              ...
              <a
                ...
                className="flex w-full items-center justify-center gap-2 rounded-ds-md border border-ds-brand-muted px-4 py-2 text-sm font-medium text-ds-text-brand hover:bg-ds-brand-surface dark:hover:bg-ds-brand-subtle transition-colors"
              >
          ...
          <Card>
            <h2 className="mb-3 text-base font-semibold text-ds-text-primary">Danger Zone</h2>
            <Button
              variant="outline"
      ...
      >
        <p className="text-ds-text-secondary">
          Are you sure you want to permanently delete <strong>&ldquo;{product.name}&rdquo;</strong>?
