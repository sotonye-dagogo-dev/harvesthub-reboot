...
import { mockUsers, mockAddresses } from "@/lib/data/mockData";
...
export default function ProfilePage() {
  ...
  // Mock user data (buyer-1)
  const user = mockUsers.find((u) => u.id === "buyer-1");
  const userAddresses = mockAddresses.filter((a) => a.userId === "buyer-1");
          ...
          <Card>
            <div className="mb-6 flex items-center gap-6">
              <div className="relative">
                ...
                >
                  <button
                    className="absolute bottom-0 right-0 flex h-8 w-8 items-center justify-center rounded-full bg-purple-600 text-white hover:bg-purple-700"
