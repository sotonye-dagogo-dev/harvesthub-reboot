...
- `.ai-system/agents/system-architecture.md` (only if architectural contract changed)
- `.ai-system/memory/project-decisions.md` (only if a durable decision is introduced)
- `.ai-system/agents/repair-system.md` (only if new recurring failure pattern was discovered/fixed)
