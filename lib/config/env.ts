...
const envSchema = z.object({
  ...
  CIS_API_URL: z.string().optional(),
  CIS_PLATFORM_SLUG: z.string().optional(),
  CIS_CLIENT_ID: z.string().optional(),
  CIS_CLIENT_SECRET: z.string().optional(),
  CIS_WEBHOOK_SECRET: z.string().optional(),
  CIS_WEBHOOK_PATH: z.string().optional(),
  CIS_WEBHOOK_ALLOWED_SKEW_SECONDS: z.string().optional(),
...
export const env = {
  ...
  cisApiUrl: raw.CIS_API_URL,
  cisPlatformSlug: raw.CIS_PLATFORM_SLUG || 'myharvesthub',
  cisClientId: raw.CIS_CLIENT_ID,
  cisClientSecret: raw.CIS_CLIENT_SECRET,
  cisWebhookSecret: raw.CIS_WEBHOOK_SECRET,
  cisWebhookPath: raw.CIS_WEBHOOK_PATH || '/api/cis/webhook',
  cisWebhookAllowedSkewSeconds: toPositiveInt(raw.CIS_WEBHOOK_ALLOWED_SKEW_SECONDS, 300),
