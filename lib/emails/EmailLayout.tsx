      ...
      <Body style={bodyStyle}>
        <Container style={containerStyle}>
          ...
          <Section style={footerStyle}>
            ...
            <Text style={footerTextStyle}>
              <Link href={`${appUrl}/help`} style={footerLinkStyle}>Help</Link>
              {' · '}
              <Link href={`${appUrl}/privacy`} style={footerLinkStyle}>Privacy</Link>
              {' · '}
              <Link href={`${appUrl}/terms`} style={footerLinkStyle}>Terms</Link>
            </Text>
          </Section>
        </Container>
      </Body>
